     ...
     ?>
          ...
          <li>
            <div>
              ...
              <h4 style="color:#7fba00;"><?php echo $Fetch_product['products_url']; ?></h4>
              <br class="spacer" />
             
              <h4>$<?php echo $Fetch_product['products_price']; ?></h4>
              <h3 style="color:#2D64DB;">ONLY $<?php echo $Fetch_product['actual_price']; ?> TODAY!</h3>
              <br class="spacer" />
