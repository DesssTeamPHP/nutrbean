...
<p>We are so confident that you will see fast dramatic results in the way you feel that if you are not competely satisfied within 30 days, simply return your bottle for a full refund. We will even give you a $5 Starbucks gift card just for trying it out. TRY NOW!</p>
</span>
    ...
    <ul>
      <li>
        <div>
          ...
          <hr class="hr_1">
          <span>
          <p>Already take a Multivitamin? </p>
          <br class="spacer">
...
<div class="bg_3 fleft specific_1">
  <p>Don´t let life slow you down, get on the road to restoring the balance your body needs today with Nutrabean. Caffeine may provide short-term energy but can actually drain your body of energy a few hours after consumption. Nutrabean helps provides sustained energy throughout the day.</p>
  <div class="spacer"></div>
</div>
<div class="fleft specific_2">
  <p>The clinically studied ingredient found in Nutrabean showed a 79% increase in energy compared to a placebo
    ...
    including flushing and sweating, headache, heart palpitations, insomnia, irritability, and inability to concentrate.</p>
  <div class="spacer"</div>
</div>
</div>
<div class="container">
    ...
    <ul>
      ...
      <li>
        <div> <img src="images/tablet_box_1.png" alt="" title=""> <span> <img src="images/nutrabean.png" alt="" title=""> <br class="spacer">
          <p>Revolutionary Multivitamin for coffee drinkers formulated using 4 clinically proven ingredients to help restore balance.</p>
          </span> </div>
      </li>
    </ul>
    <div class="spacer"></div>
...
<div class="caffine_effects">
  ...
  <div class="fright negative"> <a class="read_more2" href="#">NEGATIVE EFFECTS</a>
    <ul>
      <li>
        <h6>Stress:</h6>
        Coffee Stimulates the central nervous system, which is interpreted as stress by your adrenal glands. The adrenal glands produce the same stress hormones that prepare your body for "fight or flight". When this occurs repeatedly in response to your daily caffeine consumption, it can lead to light blood pressure and adrenal fatigue. Short term effects include an increased heart rate that can cause you to feel jittery or anxious.</li>
      <li>
        <h6>Hydration:</h6>
...
<div class="container">
  <div class="clinic bg_4">
    <p>Clinical studies have indicated that the additional ingredients in nutrabean multivitamins can help combat some of coffee's unwanted affects.</p>
  </div>
</div>
<div class="container">
  <div class="caffine">
  ...
  <div class="key_clinic">
    ...
    <p>Is restoring a healthy balance important to you? Nutrabean's 4 unique compounds each combat the unwanted affects caffeine can have.</p>
...
<div class="vitamins">
  ...
  <ul>
    <li> <img src="images/step1.jpg" alt="" title="">
      <p style="text-align:left;"> For best results take your Nutrabean multivitamins one hour prior to or after consuming caffeine. </p>
    </li>
...
<div class="container">
  <div class="drinkers">
    <div class="common_head2">
      <h2> Nutrabean is the Best Multimitavin choice for coffee drinkers </h2>
    </div>
...
<div class="people_say">
  ...
  <?php 
	            ...
	            <img src="admin/uplodeImage/testimonial/'.$testiomial_results['testimonial_image'].'" width="130" height="133"  alt="'.$testiomial_results['testimonial_name'].'" title="'.$testiomial_results['testimonial_name'].'" />
			     
			   <div class="arrow_box1 ">
                <p>'.substr(stripslashes($testiomial_results['testimonial_comment']),0,1000).'</p>
               </div>
               <span>
              <p><small>-'.$testiomial_results['testimonial_name'].'</small>		  
			  </p><div class="rating_img"></div>	
			  <br>
...
<div class="satisfaction">
  ...
  <p>We are so confident that you´ll see fast dramatic results in the way you feel that if you 
    aren´t completely satisfied after 30 days, simply return your bottle for a full refund. 
    We will even give you a $5 Starbucks gift card just for trying it out.</p>
  <img src="images/medical.jpg" alt="" title="">
  <h5>Get on the Road to Restoring the Balance
    Your Body Needs Today! </h5>
  <div> <a href="plus.php" style="margin:0px 0px 0px 100px;" ><img   src="images/get_started.png" alt=""  title=""> </a> </div>
