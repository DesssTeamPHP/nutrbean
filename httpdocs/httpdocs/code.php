...
function city()
{
$path_full='http://www.nutrabean.local-listing.us/';
$query = "";
$query_result = "";
$resultset = "";
$city = "";
$query = "selectfile_name  from menu_page_tbl  where  order by order_id";
$query_result = mysql_query($query);
$count_rows   = mysql_num_rows($query_result);
$cityi=1;
while($resultset = mysql_fetch_assoc($query_result))
{
	$city.="<li><a href='".$resultset['file_name']."'>".$resultset['title']."</a></li> ";	
	if($cityi != $count_rows )
	{
	$city.="|";	
	}
