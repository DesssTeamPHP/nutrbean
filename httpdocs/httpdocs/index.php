    ...
    <ul>
      <li>
        <div>
          ...
          <hr class="hr_1">
          <span>
          <p>Already take a Multimitamin? </p>
          <br class="spacer">
    ...
    <ul>
      ...
      <li>
        <div> <img src="images/tablet_box_2.png" alt="" title=""> <span> <img src="images/nutrabean.png" alt="" title=""> <br class="spacer">
          <p>Revolutionary Multimitamin for coffee drinkers formulated using 4 clinically proven ingredients to help restore balance.</p>
          </span> </div>
      </li>
    </ul>
    <div class="spacer"></div>
...
<div class="caffine" id="product1">
  <h2 id="affects_new">How Caffeine Effects your Body</h2>
  <div class="spacer"></div>
</div>
...
<div class="container">
  <div class="drinkers">
    ...
    <br class="spacer">
    <span> *Centrum&reg; Multimitamin Multimineral Supplement for Adults Under 50 <br class="spacer">
    </span> <span> * One Day&reg; Men & Women Multimitamins </span> </div>
  <br class="spacer">
</div>
<div class="container">
