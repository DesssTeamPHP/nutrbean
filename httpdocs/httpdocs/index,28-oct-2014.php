    ...
    <ul>
      <li>
        <div>
          ...
          <hr class="hr_1">
          <ol class="learn_more">
            <li><a href="#affects_new">How Caffeine Affects your Body</a></li>
          ...
          <br class="spacer">
          <a href="plus.php">Click here</a> <br class="spacer">
          </span> </div>
      </li>
      <li>
...
<div class="spacer"></div>
<div class="container">
<div class="caffine" id="product1">
  <h2 id="affects_new">How Caffeine Affects your Body</h2>
  <div class="spacer"></div>
</div>
...
<div class="container">
<div class="vitamins" id="take_vitamins" style="float:none !important;">
...
<div class="container">
  <div class="drinkers">
    ...
    <br class="spacer">
    <span> *Centrum&reg; Multivitamin Multimineral Supplement for Adults Under 50 <br class="spacer">
    </span> <span> * One Day&reg; Men & Women Multivitamins </span> </div>
  <br class="spacer">
</div>
<div class="container">
...
<div class="people_say">
  ...
  <?php 
	            ...
	            <div class="photo_frame_bg"><img src="admin/uplodeImage/testimonial/'.$testiomial_results['testimonial_image'].'" width="130" height="133"  alt="'.$testiomial_results['testimonial_name'].'" title="'.$testiomial_results['testimonial_name'].'" /></div>
...
<div class="satisfaction">
  ...
  <p>We are so confident that you will see fast dramatic results in the way you feel that if you 
  ...
  <h5>Get on the Road to Restoring the Balance<br />
    Your Body Needs Today! </h5>
  <div> <a href="index.php" style="margin:0px 0px 0px 100px;" ><img   src="images/get_started.png" alt=""  title=""> </a> </div>
