  ...
  <div class="banner">
    <div class="multivation">
      ...
      <div class="supplement">
        <p><!--Help combat the negative effects caused by caffeine.*-->Helps combat some of caffeine’s unwanted effects*</p>
      </div>
    ...
    <div class="sign_up">
      ...
      <ul>
        ...
        <li>
          ...
          <span><!--Yes! send me promotions!-->Send</span> </li>
        <li class="spacer"></li>
      </ul>
...
<div class="container">
  <div class="doctor_add fleft border_top_bottom">
    <ul>
      ...
      <li>
        <div> <img src="images/tablet_box_2.png" alt="" title=""> <span> <img src="images/nutrabean.png" alt="" title=""> <br class="spacer">
...
<div class="container">
<div class="caffine">
  <h2>How Caffeine Affects your Body</h2>
  <div class="spacer"></div>
</div>
<div class="caffine_effects">
  <div class="fleft possitive"> <a class="read_more1" href="#">POSITIVE AFFECTS</a>
    <ul>
  ...
  <div class="fright negative"> <a class="read_more2" href="#">NEGATIVE AFFECTS</a>
    <ul>
      <li>
        <h6>Stress:</h6>
       Coffee stimulates your central nervous system, causing you some stress in the process. When this occurs repeatedly due to your daily caffeine intake, it can result in a high blood pressure and adrenal fatigue. Short term symptoms also include an elevated heart rate that can cause feelings of anxiety.</li>
      <li>
        <h6>Hydration:</h6>
...
<div class="container">
  ...
  <div class="key_clinic">
    ...
    <p>Is restoring a healthy balance is important to you? Nutrabean's includes 4 unique compounds each used to help combat some of caffeine’s unwanted effects.</p>
