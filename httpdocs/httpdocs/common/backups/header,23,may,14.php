...
<div class="wrapper bg-2">
  <div class="container">
    <p class="flright" > <a   title="<?php  if($cnt_sc_price>0)			
			echo "Your Cart Value : $ ".$gtotal;
			else
			echo "Your Shopping Cart Is Empty";
			?>" style="text-decoration:none; color:#030000; " href="<?=$full_path;?>add_to_cart.php"> Shopping Cart:$
      <?php if($cnt_sc_price>0)			
			echo $gtotal;
			else
			echo "0";
			$gtotal="";
    ...
    <ul class="nav">
      ...
      <?php 
	    ...
	    $qry_products = "select products_url,products_name,products_id from products where status = 'Enabled'"; 
