...
<div class="container">
  ...
  <div class="banner1">
    <div class="multivation1">
      ...
      <p>Take once daily with a Multivitamin <br>
...
<p>We are so confident that you will see fast dramatic results in the way you feel that if you are not competely satisfied within 30 days, simply return your bottle for a full refund. We will even give you a $5 Starbuck gift card just for trying it out. TRY NOW!</p>
</span>
    ...
    <ul>
      <li>
        <div>
          ...
          <br class="spacer">
          <a href="index.php">Back to Nutratean Multivitamin Page</a> <br class="spacer">
          </span>
          </div>
    ...
    <ul>
      ...
      <li>
        <div> <img src="images/tablet_plus_2.png" alt="" title=""> <span> <img src="images/nutrabean.png" alt="" title=""> <br class="spacer">
          <p>Revolutionary Dietary Suppleyment for coffee drinkers formulated using 4 clinically proven ingredients to help restore Balance.</p>
           </span> 
           <br class="spacer">
           <br class="spacer">
  ...
  <div class="fright negative"> <a class="read_more2" href="#">NEGATIVE AFFECTS</a>
    <ul>
      <li>
        ...
        Coffee stimulates your central nervous system, causing you some stress in the process. When this occurs repeatedly due to your daily caffeine intake, it can result in a high blood pressure and adrenal fatigue. Short term symptoms also include an elevated heart rate that can cause feelings of anxiety.
        </li>
      <li>
        <h6>Hydration:</h6>
...
<div class="container">
  <div class="clinic bg_4">
    <p>CThe clinically studied ingredient found in nutrabean may help combat some of caffeine’s unwanted effects.</p>
  </div>
</div>
<div class="container">
  <div class="caffine">
