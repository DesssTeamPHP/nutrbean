    ...
    <div class="step_1">
      <ul>
        ...
        <li style="margin:22px 14px 0px 5px">
          <p>Increases Resistance to Fatigue & Tension</p>
          <img src="images/work_steps2.jpg" alt="" title=""> </li>
        <li>
          <p style="margin:0px 0px 0px 26px">Increases Resistance to Fatigue & Tension</p>
          <img src="images/work_steps3.jpg" alt="" title=""> </li>
        <br class="spacer">
      </ul>
      <div >
