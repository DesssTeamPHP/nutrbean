...
/******************************============END==============************************/	 
	 ...
	 */
	$aColumns = array( 'create_date','products_id','products_name', 'products_description', 'sku_no', 'products_price', 'visibility' ,'status' );
   ...
   if ( $sWhere != "" )
   {
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
			...
			else if ( $aColumns[$i] != ' ' )
			{
				...
				$row[] = $aRow[ $aColumns[$i] ];
		         ...
		         if($Group_results_per['admin_edit']=='1')
		          {
		$row[] = '   
		<a id="smoke_confirm" href="add_product.php?id='.$aRow['products_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
        
       
         <a onclick="return del_confirm();" id="smoke_confirm" href="product.php?del_id='.$aRow['products_id'].'"> <i class="splashy-remove"></i> </a>'; } else { 
		...
		<a id="smoke_confirm" href="add_product.php?id='.$aRow['products_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
         ...
         <a onclick="return del_confirm();" id="smoke_confirm" href="product.php?del_id='.$aRow['products_id'].'"> <i class="splashy-remove"></i> </a>'; }}
