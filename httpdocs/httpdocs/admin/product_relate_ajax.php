...
//error_reporting(0);
	 ...
	 */
	$aColumns = array( 'products_id','master_categories_id','products_name', 'products_description', 'sku_no', 'products_price', 'status' ,'stock_availability' );
	...
	*/
 $sWhere = 'master_categories_id = '.$_REQUEST['id'];
 // $sWhere = '';
...
if($aRow['master_categories_id']==$_REQUEST['id'])
{
...
$check_val = '';
		...
		$row[] = $sno+1 . '<br><input type="checkbox" id="prodid'.$aRow['products_id'].'" onclick="update_category_values(\''.$aRow['products_id'].'\',\''.$_REQUEST['id'].'\')" '.$check_val.' />' ;
