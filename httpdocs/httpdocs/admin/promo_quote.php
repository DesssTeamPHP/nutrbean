...
$meta_title  =  "My Promo Quote - Administrator";
/*********************Blog**********************************************/
	//For Selecting Query
	  $Promo_tablename           =      promo_quote;
	  $FieldName                 =    'promo_quote_id';
	  $sororder                  =    'asc';
	  $Field_types               = array('promo_quote_id',
	                                      'promo_quote_name',      
                                          'promo_quote_desc',
										  'promo_quote_status', 
										  'promo_quote_groups',
										  'promo_coupon_code',
										  'promo_quote_usescoupon',
										  'promo_quote_percustomer',
										  'promo_quote_from_date',
										  'promo_quote_to_date',
										  'promo_quote_priority',
										  'promo_quote_rssfeed',
										  'promo_quote_apply',
										  'promo_quote_discount_amount',
										  'promo_quote_maximum_amount',
										  'promo_quote_discount_qty',
										  'promo_quote_apply_shipping',
										  'promo_quote_free_shipping',
										  'promo_quote_processing',
										  'create_date'
						                 );
                            
	  $Promo_select            =    $Core_Mysql->select_common_query($Promo_tablename,$FieldName,$Field_types,$sororder);
...
if(isset($_REQUEST['del_id']))
	{
	  ...
	  $Promo_delete                     =    $Core_Mysql->delete_common_query($Promo_tablename,$fieldname_one,$fieldname_one_value);
	  $Promo_execute                    =    $Core_Mysql->db_query($Promo_delete);
...
if($Group_results_per['admin_add']=='1')
		 ...
		 ?>
          ...
          <h3 class="heading ">Product <a  href="add_promo_quote.php" style="float:right; margin-top:-8px;" class="btn btn-default button-next">Add Promo Quote<i class="glyphicon glyphicon-chevron-right"></i></a></h3>
          <?php } ?>
