...
/******************************============END==============************************/
     ...
     <div style="text-align:right !important"><a href="add_shipping_details.php" ><i class="splashy-add"></i> Add Shipping</a></div>
      <?php } ?>
...
<tbody>
   	<?php
              ...
              ?>       
                <tr>
					<td><?php echo $i;?></td>
                    <td><?php echo $Shipping_results["value_from"];?></td>
                     <td><?php echo $Shipping_results["value_to"];?></td>
                    <td><?php echo $Shipping_results["handling_charges"];?></td>
               <?php	 
          
		         if($Group_results_per['admin_edit']=='1')
		          {
		        ?>
                    <td><a  href="add_shipping_details.php?id=<?php echo $Shipping_results["handling_id"];?>" ><i class="splashy-pencil"></i> </a> &nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
			  <?php
             if($Group_results_per['admin_delete']=='1')
		      {
		    ?>
                    <a href="shipping_details.php?del_id=<?php echo $Shipping_results["handling_id"];?>" id="smoke_confirm" onClick="return  myFunction();"><i class="splashy-remove"></i> </a></td><?php } ?>
