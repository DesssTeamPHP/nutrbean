...
<title><?php if(isset($meta_title)) echo $meta_title; else  echo ' Ecommerce Admin';  ?></title>
<!-- Bootstrap framework -->
...
<link href='http://fonts.googleapis.com/css?family=PT+Sans' rel='stylesheet' type='text/css'>
  <!-- dynatree -->
    <link rel="stylesheet" href="lib/dynatree/src/skin/ui.dynatree.css">
...
<body class="full_width menu_hover sidebar_hidden">