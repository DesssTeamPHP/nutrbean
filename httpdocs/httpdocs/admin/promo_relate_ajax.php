...
//error_reporting(0);
	 ...
	 */
	$aColumns = array('promo_quote_id','promo_quote_name', 'promo_quote_desc', 'promo_coupon_code', 'promo_quote_discount_amount', 'promo_quote_status');
	...
	*/
 $sWhere = 'promo_quote_id = '.$_REQUEST['id'];
 // $sWhere = '';
...
if($aRow['promo_quote_id']==$_REQUEST['id'])
{
...
$check_val = '';
		...
		$row[] = $sno+1 . '<br><input type="checkbox" id="prodid'.$aRow['promo_quote_id'].'" onclick="update_category_values(\''.$aRow['promo_quote_id'].'\',\''.$_REQUEST['id'].'\')" '.$check_val.' />' ;
