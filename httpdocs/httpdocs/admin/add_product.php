          ...
          <div class="tab-content">
		   ...
		   ?> >Out of Stock</option>
            ...
            <div class="tab-pane" id="tab_br6">
              ...
              <h4 >Categories</h4><a href="javascript:void(0)" id="btnDeselectAll">( Clear Category )</a>
              <br /><span style="margin-bottom:5px; margin-top:5px;"></span>
                  ...
                  <tbody>
                    <tr>
                      <p>
                        ...
                        <td class="form-group">
            <label>Tab Name:<span class="f_req">*</span></label>
            <input name="tab_name[]"   class="form-control"  required="required" type="text" value="<?php echo $Product_results['tab_name'];?>">
          </td>
                        
                        
                      <td class="formSep">
				<label>Tab Description <span class="f_req">*</span></label>
				<textarea name="tab_desc[]"  required="required"  cols="10" rows="3" class="form-control"><?php echo $Product_results['tab_desc'];?></textarea>
			</td>  
