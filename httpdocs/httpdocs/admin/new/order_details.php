...
<tbody>
   	<?php
				...
				$get_order_latest ="SELECT id,order_status	,customer_id,order_id,DATE(order_created) AS date, SUM(billing_amt) AS billing_amount FROM order_tbl GROUP BY order_id  ORDER BY order_created DESC limit 0,7";		
