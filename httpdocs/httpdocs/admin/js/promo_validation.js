	...
	gebo_validation = {
		...
		product_add_valid: function() {
			var ttip_validator = $('.frm_product_add_valid').validate({
                ...
                rules: {
					promo_quote_name: { required: true, minlength: 3 }, 
					promo_coupon_code: { required: true, minlength: 1 },
					promo_quote_discount_amount: { required: true, minlength: 1 },
					promo_quote_maximum_amount: { required: true, minlength: 1 }
