	...
	gebo_validation = {
		...
		product_add_valid: function() {
			var ttip_validator = $('.frm_product_add_valid').validate({
                ...
                rules: {
					attribute_code: { required: true, minlength: 3 }, 
					attribute_default_value: { required: true, minlength: 1 },
					attribute_admin: { required: true, minlength: 1 },
					attribute_default_store: { required: true, minlength: 1 }
