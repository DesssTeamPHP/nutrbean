...
/******************************============END==============************************/	 
	 ...
	 */
	$aColumns = array('create_date','attribute_id','attribute_code', 'attribute_default_value', 'attribute_admin', 'attribute_values_required','attribute_apply_to', 'attribute_default_store');
   ...
   if ( $sWhere != "" )
   {
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
			...
			else if ( $aColumns[$i] != ' ' )
			{
				...
				$row[] = $aRow[ $aColumns[$i] ];
		         ...
		         if($Group_results_per['admin_edit']=='1')
		          {
		$row[] = '   
		<a id="smoke_confirm" href="add_catalog_product_attribute.php?id='.$aRow['attribute_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
        
       
         <a onclick="return del_confirm();" id="smoke_confirm" href="catalog_product_attribute.php?del_id='.$aRow['attribute_id'].'"> <i class="splashy-remove"></i> </a>'; } else { 
		...
		<a id="smoke_confirm" href="add_catalog_product_attribute.php?id='.$aRow['attribute_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
         ...
         <a onclick="return del_confirm();" id="smoke_confirm" href="catalog_product_attribute.php?del_id='.$aRow['attribute_id'].'"> <i class="splashy-remove"></i> </a>'; }}
