...
<html lang="en">
     <?php
     include('common/meta_head_common.php');
    ?> 
    ...
    <div class="main_content">
     <?php
	include('common/header_down.php');
	?>	
    <div class="row">
    <div class="col-sm-12 col-md-12">
        <h3 class="heading">Admin Menu Link</h3>
        <menu id="nestable-menu">
 <a href="menu_group.php"><button type="button"  class="btn btn-primary">previous</button> </a>
...
<div class="dd" id="nestable2">
   <h2>Admin Menus Name</h2>
    ...
    <ol class="dd-list" >
	  ...
	  <?php    $query_new_var= "select * from admin_cms_menu where admin_menuid NOT IN(select b.admin_menuid as admin_menuid from menu_group_child a,admin_cms_menu b where a.admin_menugroupid = ".$_REQUEST['id']." and a.admin_menuid=b.admin_menuid) ";
			  $query_new_varval= mysql_query($query_new_var);
	   while($row_new = mysql_fetch_array($query_new_varval)) {  ?>
