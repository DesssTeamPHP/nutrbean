...
function recursive_menu($id)
	...
	$statue='class=""';
		...
		$qry_result2 = mysql_query($qry2);
		  ...
		  {
		 echo '<li id="tree-'.$row['categories_id'].'" ><a onclick="go_cat_val(\''.$row['categories_id'].'\');" href="categories.php?cat_id='.$row['categories_id'].'" >'.$row['categories_name'].'</a>';
		}
		else
		{
echo '<li '.$statue.' id="tree-'.$row['categories_id'].'" class="folder"><a onclick="go_cat_val(\''.$row['categories_id'].'\');" href="categories.php?cat_id='.$row['categories_id'].'"  >'.$row['categories_name'].'</a><ul class="sub" >';		 
...
?>
 ...
 <!-- <link rel="stylesheet" href="css/jquery.treeview.css" />-->
  <script src="js/jquery.min.js"></script>
	...
	<script src="js/gebo_dynamic_tree.js"></script>
