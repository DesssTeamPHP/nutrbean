...
{
$products_url	                 =  print_seo_link($_REQUEST['products_url']) ;
		...
		while($fetch_select_page_category=mysql_fetch_array($pagecat_execute))
			{
			 ...
			 ?>
                ...
                <div class="form-group">
                  ...
                  <input name="sku_no"  id="sku_no" class="form-control" tabindex="4" type="text" maxlength="50" value="<?php echo $Product_results['sku_no'];?>"><br />
<div id="disp"></div>
                </div>
                <div  class="form-group">
                  <label>URL Key : </label>
                  <input name="products_url" id="products_url" class="form-control" style="text-transform:lowercase;" tabindex="5"  type="text" maxlength="500" value="<?php echo $Product_results['products_url'];?>"><br />
<div id="disp_url"></div>
                </div>
                <div  class="form-group" style="display:none;">
		   ...
		   ?> >Disabled</option>
                ...
                <div  class="form-group">
                  ...
                  <input name="sort_order" id="sort_order" class="form-control number_only_valiq" tabindex="9"  type="text" maxlength="20" value="<?php echo $Product_results['sort_order'];?>"><br />
<div id="disp_url"></div>
                </div>
              </div>
            </div>
