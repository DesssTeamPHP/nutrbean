...
<div id="contentwrapper">
  <div class="main_content">
	...
	$end_date_ga = date('Y-m-d H:i:s');		
	  	 $get_order_data ="SELECT DATE(order_created) AS date_val, SUM(billing_amt) AS billing_amount FROM order_tbl where  order_created >= '".$start_date_ga."' and order_created <='".$end_date_ga."'  GROUP BY date_val DESC ";		
	...
	$end_date_ga_month = date('Y-m-d H:i:s');	
	 	 ...
	 	 $get_order_data_month ="SELECT DATE(order_created) AS date_val, SUM(billing_amt) AS billing_amount FROM order_tbl where  order_created >= '".$start_date_ga_month."' and order_created <='".$end_date_ga_month."'  GROUP BY date_val DESC ";
...
<style >
.mediaTableMenuClosed  { display:none !important;}</style>
