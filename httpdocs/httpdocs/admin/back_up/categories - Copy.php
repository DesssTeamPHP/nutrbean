...
<div id="maincontainer" class="clearfix">
  ...
  <div id="contentwrapper">
    ...
    <frame src="categories_ajax.php" name="content">
...
function recursive_menu($id)
	...
	$statue='style="display:block"';
		...
		{
echo '<li id="tree-'.$row['categories_id'].'" class="folder"><a onclick="go_cat_val(\''.$row['categories_id'].'\');"  >'.$row['categories_name'].'</a><ul '.$statue.'>';		 
recursive_menu($row['categories_id']);
	echo '</ul><li>';  
	 ...
	 $qry = "select * from categories where parent_id = 0"; 
		...
		{
echo '<li id="tree-'.$row['categories_id'].'" class="folder"><a onclick="go_cat_val(\''.$row['categories_id'].'\');"   >'.$row['categories_name'].'</a><ul >';	
