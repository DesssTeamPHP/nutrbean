           ...
           ?> 
            <tr>
              ...
              <td class="invoice_tar"><p class="sepH_a"><span class="sepV_b text-muted">Subtotal</span>$<?php echo number_format($gtotal,2,'.','');?></p>
                <p class="sepH_a"><span class="sepV_b text-muted">Shipping Amount</span>$<?php if(trim($nt111['shipping_amt'])!="") echo  $nt111['shipping_amt']; else echo '0.00';?></p>
                <p class="sepH_a"><span class="sepV_b text-muted">Tax </span>$ <?php if(trim($nt111['tax_amt'])!="")  echo $nt111['tax_amt']; else echo '0.00';?></p>
                <p class="sepH_a text-success"><strong><span class="sepV_b">Total</span>$<?php if(trim($nt111['billing_amt'])!="") echo $nt111['billing_amt']; else echo '0.00';?></strong></p></td>
            </tr>
          </tbody>
        </table>
      </div>
