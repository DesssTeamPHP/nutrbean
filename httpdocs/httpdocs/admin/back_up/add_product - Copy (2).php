              ...
              <table id="dataTable_new" class="form" border="1">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td  ><input type="text" class="form-control1"  name="tab_name[]" value="<?php echo $tab_name[$a]; ?>">
                    </td>
                    <td  ><input type="text" class="form-control1"  name="tab_desc[]" value="<?php echo $tab_desc[$a]; ?>">
                    </td>
              ...
              <table id="dataTable_new" class="form" border="1" style="display:block;">
                <tbody>
                  <tr>
                    ...
                    <td ><input name="tab_name[]"   class="form-control1"  required="required" type="text" value="">
                    </td>
...
cell2.innerHTML = '<input type="text" name="tab_name[]" id="tab_name[]"  class="form-control" style="background-color:#FFFFFF;" value="" />'; //append data to cell
 
 
var cell3 = row.insertCell(2);
      
cell3.innerHTML = '<textarea style="width: 200px; height: 40px;"style="background-color:#FFFFFF" id="tab_desc[]" class="form-control" name="tab_desc[]"></textarea> '; //append data to cell
