          ...
          <div class="tab-pane" id="tab_br5">
		   ...
		   ?> >No</option>
            ...
            <div  class="form-group">
              ...
              <p><span class="label label-default"></span></p>
              <select name="availability_type" id="manage_type"  tabindex="25" class="form-control" maxlength="50">
                <option value="">----Select---</option>
...
?>
          ...
          <div class="tab-pane" id="tab_br7">
            ...
            <form action="" class="register" method="POST">   <textarea readonly="readonly" name="norows" id="norows"  style="width: 36px; height: 36px;"  cols="0" rows="0"></textarea><textarea  style="width: 36px; height: 36px;" readonly="readonly" name="nocols"  id="nocols" cols="0" rows="0"></textarea>
              <fieldset class="row2">
              <p>
