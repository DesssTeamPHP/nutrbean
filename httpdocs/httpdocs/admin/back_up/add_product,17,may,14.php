        ...
        <h3 class="heading">Product
          <div class="move_upper" style="float:right; margin-top:-8px;">
            <?php if(isset($_REQUEST['id']) != '')
			       {?>
            <button class="btn btn-primary"  name="Update" type="button" value="Update">Update</button>
            <?php  }
			     else
			      {?>
            ...
            <div class="tab-pane active" id="tab_br1">
              <div class="formSep">
                <div class="form-group">
                  ...
                  <input name="products_name"  id="products_name"class="form-control" type="text" value="<?php echo $Product_results['products_name'];?>" tabindex="1">
                  <br>
            ...
            <div class="accordion-body " id="collapseOne">
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="#tab_br2" data-toggle="tab">Prices</a></li>
                  <li><a href="#tab_br3" data-toggle="tab">Meta Information</a></li>
                  <li><a href="#tab_br4" data-toggle="tab">Inventory</a></li>
                  <li><a href="#tab_br4" data-toggle="tab">Categories</a></li>
                  <li><a href="#tab_br5" data-toggle="tab">Related Products</a></li>
                </ul>
              </div>
            </div>
          </div>
