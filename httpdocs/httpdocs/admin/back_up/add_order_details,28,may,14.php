...
<html lang="en">
 ...
 <?php $get_order_data_final ="SELECT * FROM ".ORDERDETAILS." where  order_id = '".$_REQUEST['id']."' ";		
...
<div class="row">
	<div class="col-sm-4 col-md-4">
		...
		<p class="sepH_a"><span class="sepV_b text-muted">Name</span><strong><?php echo $Order_results["first_name"].'&nbsp;'.$Order_results["last_name"]  ;?></strong></p>
		<p><span class="sepV_b text-muted">Payment On</span><strong><?php echo $Order_results["oredered_date"];?></strong></p>
        <p><span class="sepV_b text-muted">Transaction ID : </span><strong></strong></p>
        <p><span class="sepV_b text-muted">Authorization Code :&nbsp; </span><strong></strong></p>
	</div>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0">
        <tr>
         ...
         $qrychk1="select * from order_details_footer where order_id='$order_id'";
  ...
  <tr height="200px">
    <td width="50%"><table width="70%" style="margin:0 0 35px 0;">
        ';
         ...
         $qrychk11="select * from order_details where order_id='$order_id'";
    ...
    <td><table width="70%" style="padding-top:25px">
        ...
        <tr>
          ...
          <td>'.$Order_results["shipping_firstname"].'&nbsp;'.$Order_results["shipping_lastname"].'</td>
        </tr>
        <tr>
