...
/******************************============END==============************************/	 
	 ...
	 */
	$aColumns = array('create_date','promo_quote_id','promo_quote_name', 'promo_quote_desc', 'promo_coupon_code', 'promo_quote_discount_amount','promo_quote_apply', 'promo_quote_status');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "promo_quote_id";
   ...
   if ( $sWhere != "" )
   {
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
			...
			else if ( $aColumns[$i] != ' ' )
			{
				...
				$row[] = $aRow[ $aColumns[$i] ];
		         ...
		         if($Group_results_per['admin_edit']=='1')
		          {
		$row[] = '   
		<a id="smoke_confirm" href="add_promo_quote.php?id='.$aRow['promo_quote_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
        
       
         <a onclick="return del_confirm();" id="smoke_confirm" href="promo_quote.php?del_id='.$aRow['promo_quote_id'].'"> <i class="splashy-remove"></i> </a>'; } else { 
		...
		<a id="smoke_confirm" href="add_promo_quote.php?id='.$aRow['promo_quote_id'].'"> <i class="splashy-calendar_week_edit"></i></a>
         ...
         <a onclick="return del_confirm();" id="smoke_confirm" href="promo_quote.php?del_id='.$aRow['promo_quote_id'].'"> <i class="splashy-remove"></i> </a>'; }}
