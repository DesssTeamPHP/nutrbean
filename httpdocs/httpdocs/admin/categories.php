      ...
      if(isset($_REQUEST['cat_id']))
	 {
	  ...
	  else
	  {
		 ...
		 $categoryval_results ['navigation_status']='';
		  $categoryval_results ['sort_order']='';
		 $id = $categoryval_results ['categories_id'];
	  }
              ...
              <div class="tabbable tabbable-bordered">
                      ...
                      <div class="col-sm-12 col-md-12">
                        <div class="formSep">
                          <div class="form-group">
                            ...
                            <input name="Categ_Name"  id="Categ_Name"class="form-control" type="text" value="<?php echo  $categoryval_results['categories_name'];?>" tabindex="1">
                          </div>
                          <div class="form-group">
                            <label>Is Active <span class="f_req">*</span>:</label>
                            <select name="Category_Active" id="Category_Active" class="form-control" tabindex="2" >
				...
				{?>
                          ...
                          <div> <span class="btn btn-primary btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
                            <input type="file" name="imgname" id="imgname" value="<?php echo  $categoryval_results ['category_image_thump'];?>" tabindex="3">
                        ...
                        <div class="formSep">
                          ...
                          <textarea name="categories_desc" id="categories_desc" value="" cols="10" rows="3" class="form-control" tabindex="4"><?php echo $categoryval_results['categories_description'];?></textarea>
				...
				{?>
                          ...
                          <div style="width: 178px; height: 120px" class="fileupload-preview fileupload-exists thumbnail"></div>
                          <div> <span class="btn btn-primary btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>
                            <input type="file" name="image" id="image" value="<?php echo  $categoryval_results ['categories_image'];?>" tabindex="5">
                            <input type="hidden" name="imghiddenicon" id="imghiddenicon" value="<?php echo  $categoryval_results ['categories_image'];?>">
                            </span> <a data-dismiss="fileupload" class="btn btn-primary fileupload-exists" href="#">Remove</a> </div>
                        </div>
                        <div class="form-group">
                          <label>Page Title:</label>
                          <input name="Category_title"  id="Category_title"class="form-control" type="text" value="<?php echo  $categoryval_results['meta_title'];?>" tabindex="6">
                        </div>
                        <div class="formSep">
                          <label >Meta Keywords :</label>
                          <textarea name="Category_Keywords" id="Category_Keywords"  cols="10" rows="3" class="form-control" tabindex="7"><?php echo  $categoryval_results['meta_key'];?></textarea>
                        </div>
                        <div class="formSep">
                          <label >Meta Description :</label>
                          <textarea name="Category_Description" id="Category_Description"  cols="10" rows="3" tabindex="8" class="form-control"><?php echo  $categoryval_results['meta_desc'];?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="formSep">
                          ...
                          <input type="text" name="sort_order" id="sort_order"  value="<?php echo  $categoryval_results['sort_order'];?>" tabindex="9" class="form-control number_only_valiq">
                        </div>
                      </div>
                    </div>
                    <!--  Category**************************End***********************************88-->
...
.y-nav { margin:5px 0px 3px 0px !important; margin-top:-45px !important; margin-right:20px !important;}
  ...
  function update_category_values(val,catval)
  {
  

  if (document.getElementById("prodid"+val).checked == true) {
 
 
  $.ajax({
type: "POST",
url: "product_category_update.php",
data: "product_id="+ val + "&catid="+catval + "&optionval=enable",
...
type: "POST",
url: "product_category_update.php",
data: "product_id="+ val + "&catid="+catval + "&optionval=disable",
success: function(html){
//$("#disp_url").html(html);
}
});   } }
