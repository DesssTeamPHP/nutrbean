...
include('core/configuration.php');
   ...
   $query="SELECT order_created as Date,order_id as order_id,billing_amt as billing_amt,shipping_amt as shipping_amt  FROM order_tbl WHERE  order_created between '$startDate' and '$endDate' ORDER BY order_created DESC";
