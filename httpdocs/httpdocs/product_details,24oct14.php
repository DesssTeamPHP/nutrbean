     ...
     ?>
          ...
          <li>
            <div>
              ...
              <br class="spacer" />
              <hr />
              <h3>$<?php echo $Fetch_product['products_price']; ?></h3>
              <hr />
              <br class="spacer" />
              <p><?php echo substr(stripslashes($Fetch_product['products_description']),0,1000); ?></p>
              
              <a id="product_stat_<?php echo $Fetch_product['products_id']; ?>" style="cursor:pointer"  onclick="product_select('<?php echo$Fetch_product['products_id']; ?>','<?php echo $Fetch_product['products_price']; ?>','<?php echo $product_value;?>')">
              <?php if($product_id==$Fetch_product['products_id']) echo 'Selected'; else  echo 'Select the Product';?>
              </a>
